...
#[allow(dead_code)]
// TODO
const MOUSE_EVENTS: [u32; 5] = [0, 0, 0, 0, 0];
// #[allow(dead_code)]
// const MOD_TYPES: [(KeyboardModifier, Keysym); 7] = [
...
#[allow(dead_code)]
pub fn num_to_mods(modifiers: u32) -> Vec<Keysym> {
    unimplemented!()
    // let mut res = vec![];
...
#[allow(non_upper_case_globals)]
pub fn mods_to_num(modifiers: Table) -> rlua::Result<u32> {
    unimplemented!()
