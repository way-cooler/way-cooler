use wlroots::{wlroots_dehandle, CompositorHandle, OutputBuilder, OutputBuilderResult,
...
impl OutputManagerHandler for OutputManager {
                             ...
                             -> Option<OutputBuilderResult<'output>>
    {
        ...
        let ::Server { ref mut cursor_handle, ref mut layout_handle, ref mut xcursor_manager, .. } =
            *server;
